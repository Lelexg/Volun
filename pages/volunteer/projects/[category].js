...
const Index = () => {
  ...
  useEffect(() =>{
    if (typeof document !== 'undefined') {
      if(category){
        if(document.getElementById(category.charAt(0).toUpperCase() + category.slice(1))){
          console.log(document.getElementById(category.charAt(0).toUpperCase() + category.slice(1)))
          document.getElementById(category.charAt(0).toUpperCase() + category.slice(1)).checked = true;
          setFilterProject(category.charAt(0).toUpperCase() + category.slice(1), true)
        }
      }
      getProjects(
      {
